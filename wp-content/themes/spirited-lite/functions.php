...
define('SKT_URL','http://www.sktthemes.net','spirited-lite');
define('SKT_THEME_URL','http://www.sktthemes.net/themes','spirited-lite');
define('SKT_THEME_DOC','http://sktthemesdemo.net/documentation/spirited-doc/','spirited-lite');
define('SKT_PRO_THEME_URL','http://www.sktthemes.net/shop/spirited-corporate-wordpress-theme/','spirited-lite');
define('SKT_FREE_THEME_URL','http://www.sktthemes.net/product-category/free-wordpress-themes/','spirited-lite');
define('SKT_LIVE_DEMO','http://sktthemesdemo.net/skt-corporate/','spirited-lite');
