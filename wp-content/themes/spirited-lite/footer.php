...
<div id="footer-wrapper">
        ...
        <div class="copyright-wrapper">
        	<div class="container">
                <div class="copyright-txt"><?php esc_attr_e('&copy; 2016','spirited-lite');?> <?php bloginfo('name'); ?>. <?php esc_attr_e('All Rights Reserved', 'spirited-lite');?></div>
                <div class="design-by"><?php printf('<a href="'.esc_url(SKT_FREE_THEME_URL).'" rel="nofollow" target="_blank">Spirited Lite Theme</a>' ); ?></div>
            </div>
            <div class="clear"></div>
        </div>
    </div>
